...
$pdf->SetFillColor(179,149,149);
$pdf->Cell(210,50,'',0,0,'',true);
$pdf->Image('bekreta.png',5,5,65,40);
$pdf->SetXY(120,5);
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','BI',17);
$pdf->MultiCell(60,8,$row['cName']."  (".$row['cBusiness']." )",0,0);
$pdf->SetXY(120,20);
...
$pdf->SetXY(0,224);
$pdf->SetFont('Times','I',10);
$pdf->SetFillColor(200,222,241);
$pdf->Cell(210,20,'',0,0,'',true);
...
$pdf->SetXY(10,265);
$pdf->SetFont('Times','BI',20);
$pdf->Cell(190,10,'    FUNDING NEEDED Rs. '.$var,1,0,'C');
$pdf->Output();
?>