...
$this->SetY(282);
$this->Cell(0,10,'Business Pitch Deck',0,0,'L');
}
...
// $pdf->Line(80,60,80,230);//||
// $pdf->Line(145,60,145,230);//||
// $pdf->Line(80,118,220,118);//-----
// $pdf->Line(80,173,220,173);//-----
// $pdf->Line(0,230,220,230);//-----
// $pdf->Line(0,265,220,265);//-----
// $pdf->Line(0,280,220,280);//-----
$pdf->Image( 'images/pitch/bg1.jpg', 0, 0, 210, 298);

// $pdf->Image( 'images/pitch/strip.jpg', 0, 0, 210, 60);
$pdf->Image( 'images/logo.jpg', 15, 10, 45, 15);
$pdf->SetFont('Arial','B',22);
$pdf->SetTextColor(0);

$pdf->SetXY(150,15);
$pdf->MultiCell(80,8, "_________________");
$pdf->ln(5);
$pdf->SetX(110);
$pdf->SetFont('Arial','B',18);
$pdf->MultiCell(80,8, "SARESTATES REALITY ADVISOR PVT LTD.");
$pdf->SetX(110);
$pdf->SetFont('Arial','B',22);
$pdf->MultiCell(80,5, "_________");
$pdf->SetFont('Arial','U',13);
$pdf->SetTextColor(50,20,255);
$pdf->SetX(15);
...
$pdf->SetXY(25,65);
$pdf->MultiCell(40,8, "THE PROBLEM");
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0);
$pdf->SetX(5);
$pdf->MultiCell(70,5, "-While working with jQuery regularly can, over time");
$pdf->SetX(5);
$pdf->MultiCell(70,5, "-While working with jQuery regularly can, over time");
$pdf->SetX(5);
$pdf->MultiCell(70,5, "-While working with jQuery regularly can, over time");
...
$pdf->SetTextColor(255,36,54);
$pdf->SetX(25);
$pdf->MultiCell(40,8, "THE SOLUTION");
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0);
$pdf->SetX(5);
$pdf->MultiCell(70,5, "-While working with jQuery regularly can, over time");
...
$pdf->SetTextColor(255,36,54);
$pdf->SetX(25);
$pdf->MultiCell(0,8, "MEET OUR OWNER");
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0);
$pdf->SetX(5);
$pdf->MultiCell(70,5, "Name : Mr. Amit Choudhary");
$pdf->SetX(5);
$pdf->MultiCell(70,5, "Since : Year 2005");
$pdf->SetX(5);
$pdf->MultiCell(70,5, "Capital : Rs 5cr ");
$pdf->SetX(5);
$pdf->MultiCell(70,5, "");
...
$pdf->SetTextColor(255,36,54);
$pdf->SetXY(105,65);
$pdf->MultiCell(40,8, "VISION");
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0);
$pdf->SetX(85);
$pdf->MultiCell(55,5, "\"Getting started with jQuery can be easy or challenging, depending on your experience with JavaScript, HTML, CSS, and programming concepts in general.\"");

$pdf->SetFont('Arial','UB',12);
$pdf->SetTextColor(255,36,54);
$pdf->SetXY(98,120);
$pdf->MultiCell(40,8, "COMPETITORS");
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0);
$pdf->SetX(85);
$pdf->MultiCell(55,5, "-While working with jQuery regularly can, over time");
$pdf->SetX(85);
$pdf->MultiCell(55,5, "-While working with jQuery regularly can, over time");
$pdf->SetX(85);
$pdf->MultiCell(55,5, "-While working with jQuery regularly can, over time");
...
$pdf->SetTextColor(255,36,54);
$pdf->SetXY(163,120);
$pdf->MultiCell(40,8, "MARKET GAP");
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0);
$pdf->SetX(153);
$pdf->MultiCell(53,5, "-While working with jQuery regularly can, over time");
$pdf->SetX(153);
$pdf->MultiCell(53,5, "-While working with jQuery regularly can, over time");
$pdf->SetX(153);
$pdf->MultiCell(53,5, "-While working with jQuery regularly can, over time");
...
$pdf->PieChart(120, 48, $data3, '%l (%p)',$col);
...
$pdf->SetTextColor(0);
$pdf->SetXY(15,229);
$pdf->BarDiagram(180,30,$data2,'%l',$col1);

// $pdf->Image( 'images/pitch/strip.jpg', 0, 260, 210, 20);
$pdf->Image( 'images/pitch/location.png', 10, 266, 5, 5);
$pdf->SetFont('Arial','',11);
$pdf->SetXY(18,266);
$pdf->MultiCell(50,5, "Kurla,Mumbai - 400070");

$pdf->Image( 'images/pitch/phone.png', 80, 266, 5, 5);
$pdf->SetXY(87,266);
$pdf->MultiCell(50,5, "+91 9773383276");

$pdf->Image( 'images/pitch/email.png', 140, 267, 5, 4);
$pdf->SetXY(148,266);
$pdf->MultiCell(50,5, "admin@sarestates.in");
$pdf->AddPage();



// $pdf->Output("Business Plan.pdf","D");
$pdf->Output();
?>